...
### **Tecnologias:**
Para aprimorar o site, utilizamos um conjunto moderno de tecnologias que garantem desempenho, organização e uma interface mais acessível. O projeto foi desenvolvido com Next.js, um framework avançado que oferece carregamento rápido, otimização automática e melhor experiência do usuário.
A estrutura funcional foi construída em JavaScript e React, permitindo componentes reutilizáveis e uma navegação mais fluida.
Para o design, utilizamos Tailwind CSS, que possibilitou criar uma interface limpa, responsiva e visualmente consistente.

Essas tecnologias, combinadas, contribuíram para tornar o site mais eficiente, acessível e alinhado às boas práticas de desenvolvimento moderno.
